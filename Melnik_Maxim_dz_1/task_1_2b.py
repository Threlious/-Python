...
checklist_up = checklist
for idx3 in range(len(checklist_up)):  # цикл прибакви 17 к каждому элементу массива
    checklist_up[idx3] += 17
total_sum = 0  # сумма необходимых чисел в массиве
for num_checklist in checklist_up:
